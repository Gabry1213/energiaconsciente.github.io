...
(function ($) {
  $(function () {
    ...
    var puzzleData = [
      ...
      {
        clue: "Qual fonte de energia é mais prejudicial para o meio ambiente?",
        answer: "COMBUSTIVEL FOSSIL",
        position: 5,
        orientation: "across",
        startx: 1,
        starty: 3,
      ...
      {
        clue:
          "Control system strategy that tries to replicate the human through process (abbr.)",
        answer: "ann",
        position: 4,
        orientation: "down",
        startx: 9,
